# Contributing to android-testing-skills

Thanks for considering a contribution. The library covers Android testing across five sets — Compose UI testing, fundamentals (pyramid, doubles, strategies), JVM unit tests (JUnit4, Mockito, MockK, coroutines, Turbine, Robolectric), instrumentation (AndroidJUnit4, ActivityScenario, FragmentScenario, Espresso, UiAutomator), and ADB-driven device E2E. Every contribution either adds a new focused skill or improves an existing one.
